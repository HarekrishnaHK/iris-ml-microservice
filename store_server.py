...
class StoreServiceServicer(store_pb2_grpc.StoreServiceServicer):
    def SaveRegress(self, request, context):
        ...
        return store_pb2.SaveResponse(success=True, message="Regression result saved to DB.")
    ...
    def SaveClassify(self, request, context):
        ...
        return store_pb2.SaveResponse(success=True, message="Classification result saved to DB.")
